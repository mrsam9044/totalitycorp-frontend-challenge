...
const Addblog = () => {
    ...
    return ( <
        div >
        <
        h3 classNameName = "mb-4 title" > { getBlogId !== undefined ? "Edit" : "Add" }
        Blog <
        /h3>
        ...
        classNameName = "form-control py-3  mt-3"
        id = "" >
        <
        ...
        /div> <
        div classNameName = "bg-white border-1 p-5 text-center mt-3" >
        <
        Dropzone onDrop = {
        ...
        /Dropzone> <
        /div> <
        div classNameName = "showimages d-flex flex-wrap mt-3 gap-3" > {
            imgState ? .map((i, j) => {
                return ( <
